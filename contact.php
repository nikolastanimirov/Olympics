<?php 
	...
	//Get post data
	if(isset($_POST['name']) and isset($_POST['mail']) and isset($_POST['comment']) and isset($_POST['telephone']) and isset($_POST['subject'])){
		$name 	 = $_POST['name'];
		$mail 	 = $_POST['mail'];
		...
		if($name == '') {
			...
			echo json_encode(array('info' => 'error', 'msg' => "Please enter a subject."));
		} else {
			//Send Mail
			$to = __TO__;
